...
namespace PD.LYY.UtilityLib
{
    public static class ExpressionExtensions
    {
        ...
        #region Value(获取LamdaExtension表达式的值)

        /// <summary>
        /// 获取LamdaExtension表达式的值
        /// </summary>
        /// <typeparam name="T">对象类型</typeparam>
        public static object Value<T>(this Expression<Func<T, bool>> expression)
        {
            return LamdaExtension.GetValue(expression);
        }
        ...
        {
            return left.Equal(LamdaExtension.Constant(value, left));
        }
        ...
        {
            return left.NotEqual(LamdaExtension.Constant(value, left));
        }
        ...
        {
            return left.Greater(LamdaExtension.Constant(value, left));
        }
        ...
        {
            return left.GreaterEqual(LamdaExtension.Constant(value, left));
        }
        ...
        {
            return left.Less(LamdaExtension.Constant(value, left));
        }
        ...
        {
            return left.LessEqual(LamdaExtension.Constant(value, left));
        }
        ...
        #region ToLamdaExtension(创建LamdaExtension表达式)
        ...
        public static Expression<TDelegate> ToLamdaExtension<TDelegate>(this Expression body, params ParameterExpression[] parameters)
        {
            if (body == null)
                return null;
        ...
        {
            return ToLamdaExtension<Func<T, bool>>(body, parameters);
        }
